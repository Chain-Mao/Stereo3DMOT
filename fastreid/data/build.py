...
from .common import CommDataset, KittiDataset
...
# 数据集根目录
_root = os.getenv("FASTREID_DATASETS", "/home/simit/code/Stereo3DMOT/data")
...
def _train_loader_from_config(cfg, *, train_set=None, transforms=None, sampler=None, **kwargs):
    ...
    if train_set is None:
        ...
        train_set = KittiDataset(train_items, transforms, relabel=True)
...
def _test_loader_from_config(cfg, *, dataset_name=None, test_set=None, num_query=0, transforms=None, **kwargs):
    ...
    if test_set is None:
        ...
        test_set = KittiDataset(test_items, transforms, relabel=False)
