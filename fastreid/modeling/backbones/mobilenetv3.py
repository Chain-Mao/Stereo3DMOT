...
class MobileNetV3(nn.Module):
    def __init__(
        ...
        self.conv_stem = self.features[0][0]
        self.bn1 = self.features[0][1]
        self.act1 = self.features[0][2]

        self.block0 = self.features[layers[0]:layers[1]]    # 1---16
        self.block1 = self.features[layers[1]:layers[2]]    # 2,3---24
        self.block2 = self.features[layers[2]:layers[3]]    # 4,5,6---40
        self.block3 = self.features[layers[3]:layers[4]]    # 7,8,9,10 11,12---80，112
        self.block4 = self.features[layers[4]:layers[5]]
        self.block5 = self.features[layers[5]:]
