...
class DefaultPredictor:
    ...
    def __call__(self, left_image, right_image, disp_offset, ori_hw, x_min, y_min, focal, cx, cy):
        """
        Args:
        ...
        """
        inputs = {"left_images": left_image.to(self.model.device), "right_images": right_image.to(self.model.device), "disp_offset": disp_offset, "ori_hw": ori_hw, "x_min": x_min, "y_min": y_min, "focal": focal, "cx": cx, "cy": cy}
...
class DefaultTrainer(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        # 根据数据类别，自行调整图像resize
        if cfg['INPUT']['CLASS'] == 'Pedestrian':
            cfg['INPUT']['SIZE_TRAIN'] = [256, 128]
            cfg['INPUT']['SIZE_TEST'] = [256, 128]
        elif cfg['INPUT']['CLASS'] == 'Car':
            cfg['INPUT']['SIZE_TRAIN'] = [160, 224]
            cfg['INPUT']['SIZE_TEST'] = [160, 224]
        elif cfg['INPUT']['CLASS'] == 'Cyclist':
            cfg['INPUT']['SIZE_TRAIN'] = [192, 192]
            cfg['INPUT']['SIZE_TEST'] = [192, 192]
