...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="/home/simit/code/Stereo3DMOT/configs/AGW_M50.yml"
    )
    parser.add_argument(
        "--reid_opts",
        help="Modify config options using the command-line 'KEY VALUE' pairs",
        default=["MODEL.WEIGHTS", "/home/simit/code/Stereo3DMOT/fastreid/weights/kitti/agw_M50_point_300_Car/model_final.pth"],
...
def main_per_cat(cfg, cat, log, ID_start):
    ...
    for seq_name in seq_eval:
        ...
        for frame in range(min_frame, max_frame + 1):
            ...
            since = time.time()
            results = tracker.track(dets_frame, frame, seq_name)
...
def main(args):
    ...
    # reid config
    cfg.reid_config_file = args.reid_config_file
    cfg.reid_opts = args.reid_opts
