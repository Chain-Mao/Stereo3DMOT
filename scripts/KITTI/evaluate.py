...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path="/home/simit/code/Stereo3DMOT/scripts/KITTI", max_truncation = 0, min_height = 25, max_occlusion = 2, \
        ...
        self.t_sha             = t_sha
        self.t_path            = os.path.join("/home/simit/code/Stereo3DMOT/results/KITTI", t_sha, "data_%d" % (int(num_hypo)-1))  # 绝对路径
            ...
            for f in range(len(seq_gt)):        # go through each frame
                ...
                for gg in g:
                    ...
                    for tt in t:
                        ...
                        elif self.eval_3diou:   # 3D目标跟踪评估 eiou_3d > iou_3d > giou_3d
...
class stat:
    ...
    def plot(self):
        save_dir = os.path.join("/home/simit/code/Stereo3DMOT/results/KITTI", self.t_sha)
